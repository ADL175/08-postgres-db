...
// TODOXXX: Install and require the NPM Postgres package 'pg' into your server.js, and ensure that it is then listed as a dependency in your package.json
const fs = require('fs');
...
// TODOxx: Complete the connection string for the url that will connect to your local postgres database
...
// REVIEWxx: Use the client object to connect to our DB.
client.connect();


// REVIEWxx: Install the middleware plugins so that our app is aware and can use the body-parser module
app.use(bodyParser.json());
app.use(bodyParser.urlencoded({extended: true}));
app.use(express.static('./public'));


// REVIEWxx: Routes for requesting HTML resources
